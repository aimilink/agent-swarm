...
AgentSwarm 是 Hermes Agent 之上的本地编排与项目交付工作台：
...
| 服务管理 | Web 服务 start/stop/status/restart、PID 与日志管理、并发锁、systemd 用户服务自动接管 | `agentswarm` 命令、[服务管理](SERVICE-MANAGEMENT.md) |
